...
Ce projet a été développé dans le cadre du **Master 2 Data Management - Paris Business School**. 

Accédez au Dashboard ici : https://dashboard-bi-pff6sbtdvj39vxjwdu9wxs.streamlit.app/

Ce dashboard interactif a été conçu dans le but d'appuyer les équipes Ressources Humaines (RH) afin de prédire la probabilité qu’un employé quitte l’entreprise. Grâce à l’utilisation de la régression logistique, il permet d’analyser et de visualiser les facteurs clés influençant le turnover, tout en offrant des recommandations adaptées.

L’objectif est d’aider les décisionnaires RH à mieux comprendre les motifs du turnover et à prendre des décisions éclairées pour améliorer la rétention des employés.

## Technologies Utilisées

- **Python** : Langage principal utilisé pour le traitement des données et le Machine Learning  
- **Pandas** : Manipulation et analyse des données  
- **Scikit-learn** : Entraînement des modèles de régression logistique  
